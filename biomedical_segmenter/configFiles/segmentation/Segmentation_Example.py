...
segmentChannels = ['/CV/PublicData_allT1post.txt',
		   '/CV/PublicData_allSlope1.txt',
		   '/CV/PublicData_allSlope2.txt']
...
path_to_model = '../tuned_model/models/tuned_model.h5' #PATH TO FINETUNED MODEL
